...
public class ModelVendas {
	...
	public static String getCod() {
		return Vendas.textFieldCodCliente.getText();
	}
	public static void setCod(String codigo) {
		Vendas.textFieldCodCliente.setText(codigo);
	}
	...
	//<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
		...
		public static String getUsuario() {
			return Caixa.UserCx.getText();
		}

		public static void setUsuario(String usuario) {
			Caixa.UserCx.setText(usuario);
		}

		public static String getData() {
			return Caixa.DataCx.getText().toString();
		}

		public static void setData(String data) {
			Caixa.DataCx.setText(data);
		}

		public static String getHora() {
			return Caixa.HoraCx.getText().toString();
		}

		public static void setHora(String hora) {
			Caixa.HoraCx.setText(hora);
		}

		public static String getValor() {
			return Caixa.ValorCx.getText().toString();
		}

		public static void setValor(String valor) {
			Caixa.ValorCx.setText(valor);
		}

		public static void setFotoCliente(String string) {	
			Vendas.fotoCliente.setText("");
			ImageIcon imagem = new ImageIcon(string.replace("~", "\\").toString());
			...
			Vendas.caminhoC.setText(string.replace("\\", "~"));
			
		}

		public static void setFotoClienteDel(String string) {
			Vendas.label_16.setText("");
			ImageIcon imagem = new ImageIcon(string.replace("~", "\\").toString());
			Image img = imagem.getImage().getScaledInstance(155, 115,Image.SCALE_AREA_AVERAGING);
			Vendas.label_16.setIcon(new javax.swing.ImageIcon(img));
