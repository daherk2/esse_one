...
public class RH extends JFrame {
	...
	private JMenuBar                  menuBar,menuBar_1;
	...
	public static JTextField                agencia;
	...
	public static JTextField caminhof;
	public static JButton AtualizarIMG,btnSelecionarIMG;
	...
	public RH() {
		...
		try {
			...
			setIconImage(Toolkit.getDefaultToolkit().getImage(RH.class.getResource("/logos_solid/SimboloPSemFundo - Copia.png")));
			...
			Menu.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425606738_678125-folder-house-128.png")));
			...
			menu.setFont(new Font("Kalinga", Font.PLAIN, 14));
			menu.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425606621_678085-house-128.png")));
			...
			mnConfigurao.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425606625_678124-wrench-screwdriver-128.png")));
			...
			menuItem.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425606663_image-128.png")));
			...
			menuItem_3.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425606720_bubbles-alt-128.png")));
			...
			menu_2.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425606648_678109-profile-group-128.png")));
			...
			menuItem_1.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425606718_678075-sign-ban-128.png")));
			...
			menu_1.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425606602_678131-money-128.png")));
			...
			FastLookAndFeel.setCurrentTheme(props);
			UIManager.setLookAndFeel("com.jtattoo.plaf.fast.FastLookAndFeel");
			menuItem_2 = new JMenuItem("Abrir / Fechar Caixa");
			...
			menuItem_2.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425606821_678065-file-bookmark-128.png")));
			...
			mnAjuda.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425606598_678110-sign-info-128.png")));
			...
			mntmAbrirAjuda.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425606599_678078-light-bulb-128.png")));
			mnAjuda.add(mntmAbrirAjuda);			
			
			tabbedPaneRH = new JTabbedPane(JTabbedPane.TOP);
			tabbedPaneRH.setBounds(0, 34, 1360, 705);
			...
			if (Inicio.rd == 0) {
				...
				comboEscolaridade.addItem("Ensino médio incompleto");
				comboEscolaridade.addItem("Ensino médio completo");
			...
			scrollPaneDependentes_1.setForeground(UIManager.getColor("ScrollPane.background"));
			...
			radioSim.setBounds(1154, 132, 63, 32);
			...
			radioNao.setBounds(1218, 132, 64, 32);
			...
			radioCadastrar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
						...
						btnSelecionarIMG.setVisible(true);
						AtualizarIMG.setVisible(false);
			...
			radioConsultar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					btnSelecionarIMG.setVisible(false);					
				}
			});
			...
			btRemoverDependente.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425606572_678069-sign-error-128.png")));
			...
			btnSelecionarIMG = new JButton("Selecionar");
			btnSelecionarIMG.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
				}
			});
			btnSelecionarIMG.setForeground(Color.BLACK);
			btnSelecionarIMG.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
			btnSelecionarIMG.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					RHController.SelecionarFotoFuncionario();
				}
			});
			btnSelecionarIMG.setIcon(new ImageIcon(RH.class
			            .getResource("/icones1_24px/1425606755_camera-alt-128.png")));
			btnSelecionarIMG.setFont(new Font("Kalinga", Font.PLAIN, 14));
			btnSelecionarIMG.setBounds(716, 243, 146, 35);
			panelFuncionario.add(btnSelecionarIMG);
			
			AtualizarIMG = new JButton("Atualizar");
			AtualizarIMG.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					RH.AtualizarFoto();
				}
			});
			AtualizarIMG.setVisible(false);
			AtualizarIMG.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425606696_678121-cloud-sync-128.png")));
			AtualizarIMG.setForeground(Color.BLACK);
			AtualizarIMG.setFont(new Font("Dialog", Font.PLAIN, 14));
			AtualizarIMG.setBounds(716, 243, 146, 35);
			panelFuncionario.add(AtualizarIMG);

			menuBar_1 = new JMenuBar();
			menuBar_1.setBounds(395, 0, 564, 32);
			...
			btSalvar.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425606570_floppy-128.png")));
			...
			btnAtualizar.setVisible(false);
			btnAtualizar.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425606696_678121-cloud-sync-128.png")));
			...
			btLimpar.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/Gnome-edit-clear.png")));
			...
			button_2.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425606608_pencil-128.png")));
			...
			btnAnterior.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					RHController.ConsultarFuncAnterior();
				}
			});
			btnAnterior.setForeground(Color.BLACK);			
			btnAnterior.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425605893_arrow_left.png")));
			...
			btnPrximo.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					RHController.ConsultarProxFuncionario();
				}
			});
			btnPrximo.setForeground(Color.BLACK);			
			btnPrximo.setHorizontalTextPosition(SwingConstants.LEFT);
			btnPrximo.setIcon(new ImageIcon(RH.class.getResource("/icones1_24px/1425605875_arrow_right.png")));
			...
			separator.setBounds(928, 478, 360, 2);
			panelFuncionario.add(separator);

			labelFotoFuncionario = new JLabel("(165x115)");
			labelFotoFuncionario.setForeground(Color.BLACK);
			labelFotoFuncionario.setIcon(new ImageIcon(RH.class.getResource("/icones1_48px/1425606663_image-128.png")));
			...
			labelTelefone_1 = new JLabel("Telefone 1");
			...
			label.setIcon(new ImageIcon(RH.class.getResource("/imagens_principais/menu.png")));
			label.setBounds(0, 0, 1355, 32);
			panelFuncionario.add(label);

			// Inicio.rd=1;

			labelFundoFuncionario = new JLabel("");
			labelFundoFuncionario.setIcon(new ImageIcon(RH.class.getResource("/papel_parede/(4).png")));
			labelFundoFuncionario.setOpaque(true);
			...
			labelFundoFuncionario.setBounds(0, 0, 1355, 668);
			...
			CadastrarSalario.setText("0,00");
			CadastrarSalario.setForeground(Color.BLACK);
			CadastrarSalario.addKeyListener(new java.awt.event.KeyAdapter() {
				public void keyReleased(java.awt.event.KeyEvent evt) {
					//CadastrarSalario.setText(CadastrarSalario.getText().replaceAll( "[^0-9]", ""));
					// CadastrarSalario.setText(CadastrarSalario.getText().replaceAll("[^A-Z | ^a-z]",
					// ""));
				}
			});
			CadastrarSalario.addMouseListener(new MouseAdapter() {

				@Override
				public void mouseEntered(MouseEvent e) {
					if (CadastrarSalario.getText().equalsIgnoreCase("0,00"))
						CadastrarSalario.setText("");
					CadastrarSalario.requestFocus(true);

				}

				@Override
				public void mouseExited(MouseEvent e) {
					if (CadastrarSalario.getText().equalsIgnoreCase(""))
						CadastrarSalario.setText("0,00");
					CadastrarSalario.requestFocus(false);
				}
			...
			caminhof = new JTextField();
			caminhof.setVisible(false);
			caminhof.setOpaque(false);
			caminhof.setEnabled(false);
			caminhof.setEditable(false);
			caminhof.setSelectionColor(SystemColor.textHighlight);
			caminhof.setHorizontalAlignment(SwingConstants.CENTER);
			caminhof.setForeground(Color.BLACK);
			caminhof.setFont(new Font("Dialog", Font.PLAIN, 14));
			caminhof.setDisabledTextColor(Color.BLACK);
			caminhof.setColumns(10);
			caminhof.setBounds(10, 611, 5, 32);
			panelFuncionario.add(caminhof);			
			...
			labelFundoHolerite.setIcon(new ImageIcon(RH.class.getResource("/papel_parede/(4).png")));
			labelFundoHolerite.setOpaque(true);
			...
			labelFundoHolerite.setBounds(0, 0, 1355, 667);
			...
			button_7.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					report.TreinamentoDesenvolvimento();
				}
			});
			...
			label_5 = new JLabel("");
			label_5.setIcon(new ImageIcon(RH.class.getResource("/papel_parede/(4).png")));
			...
			label_5.setBounds(0, 0, 1355, 667);
			...
			label_2 = new JLabel("");
			label_2.setIcon(new ImageIcon(RH.class.getResource("/papel_parede/(4).png")));
			...
			label_2.setBounds(0, 0, 1355, 667);
			panelRelatorios.add(label_2);
			
			tabbedPaneRH.addTab("Funcionário ",
		            new ImageIcon(RH.class.getResource("/icones1_24px/1425606657_user-128.png")),panelFuncionario, null);
			tabbedPaneRH.addTab("Cargos / Salários",
					new ImageIcon(RH.class.getResource("/icones1_24px/1425606647_678126-box-in-128.png")),panelCargoSalario, null);
			tabbedPaneRH.addTab("Treinamento / Desenvolvimento",
				new ImageIcon(RH.class.getResource("/icones1_24px/1425606809_wrench-128.png")),panelTreinamentos, null);
			tabbedPaneRH.addTab("Relatórios",
		            new ImageIcon(RH.class.getResource("/icones1_24px/1425606695_678135-sticky-note-128.png")),panelRelatorios, null);
	...
	protected static void SetarBordaNull() {
		RH.comboNivel.setBorder(null);
		 RH.Senha1.setBorder(null);			
			RH.Usuario1.setBorder(null);
			RH.comboDepartamento.setBorder(null);
			RH.Salario1.setBorder(null);
			RH.comboCargo.setBorder(null);
			RH.Cep1.setBorder(null);
			RH.comboCidade.setBorder(null);
			RH.comboUf.setBorder(null);
			RH.Bairro1.setBorder(null);
			RH.Complemento1.setBorder(null);
			RH.Numero1.setBorder(null);
			RH.Logradouro1.setBorder(null);
			RH.agencia.setBorder(null);
			RH.comboBanco.setBorder(null);
			RH.Conta1.setBorder(null);
			RH.comboContrato.setBorder(null);;
			RH.Admissao1.setBorder(null);
			RH.Celular21.setBorder(null);
			RH.Celular11.setBorder(null);
			RH.Telefone21.setBorder(null);
			RH.Telefone11.setBorder(null);
			RH.comboEscolaridade.setBorder(null);
			RH.Dependentes1.setBorder(null);
			RH.NomeMae1.setBorder(null);
			RH.NomePai1.setBorder(null);
			RH.Admissao1.setBorder(null);
			RH.Email1.setBorder(null);
			RH.comboEstadoCivil.setBorder(null);
			RH.Ctps1.setBorder(null);
			RH.Cpf1.setBorder(null);
			RH.Rg1.setBorder(null);
			RH.Nacionalidade1.setBorder(null);
			RH.Nascimento1.setBorder(null);
			RH.Nome1.setBorder(null);
			RH.NumeroRegistro1.setBorder(null);		
	}

	protected static void AtualizarFoto() {
		...
		if (retorno == JFileChooser.APPROVE_OPTION) {
			...
			String comandosql4 = "UPDATE `erp`.`funcionarios` SET `imagem` = '" + ModelRH.getFotografia()	
	...
	public static void LimparDados() {
		NumeroRegistro1.setText("");
		Nome1.setText("");
		Nascimento1.setText("");
		Nacionalidade1.setText("");
		Rg1.setText("");
		Cpf1.setText("");
		Ctps1.setText("");
		...
		nivel.setText(null);
		AtualizarIMG.setVisible(false);
		labelFotoFuncionario.setText("Fotografia");
		labelFotoFuncionario.setIcon(new ImageIcon(RH.class.getResource("/icones1_48px/1425606663_image-128.png")));
	}
}
