...
public class Logistica extends JFrame {
	...
	public static JButton             btnLimpar, buttonAnterior,AtualizarIMG ;
	...
	public Logistica() {
		...
		try {
			...
			menu_1.setIcon(new ImageIcon(Logistica.class.getResource("/icones1_24px/1425606602_678131-money-128.png")));
			...
			menuItem.setIcon(new ImageIcon(Logistica.class.getResource("/icones1_24px/1425606821_678065-file-bookmark-128.png")));
			...
			tabbedPane.setBounds(0, 34, 1360, 705);
			...
			McWinLookAndFeel.setCurrentTheme(props);
			UIManager.setLookAndFeel("com.jtattoo.plaf.fast.FastLookAndFeel");
			btSelecionarImagem = new JButton("Fotografia");
			...
			btSelecionarImagem.setIcon(new ImageIcon(Logistica.class.getResource("/icones1_24px/1425606755_camera-alt-128.png")));
			btSelecionarImagem.setFont(new Font("Kalinga", Font.PLAIN, 14));
			btSelecionarImagem.setBounds(1144, 263, 145, 35);
			...
			AtualizarIMG = new JButton("Atualizar Foto");
			AtualizarIMG.setVisible(false);
			AtualizarIMG.addMouseListener(new MouseAdapter() {
				@Override
				public void mouseClicked(MouseEvent arg0) {
					Logistica.AtualizarFotoVeiculo();
				}
			});
			AtualizarIMG.setIcon(new ImageIcon(Logistica.class.getResource("/icones1_24px/1425606696_678121-cloud-sync-128.png")));
			AtualizarIMG.setMnemonic(KeyEvent.VK_F1);
			AtualizarIMG.setForeground(Color.BLACK);
			AtualizarIMG.setFont(new Font("Dialog", Font.PLAIN, 14));
			AtualizarIMG.setBounds(1144, 263, 145, 35);
			panelVeiculo.add(AtualizarIMG);
			...
			labelFotoVeiculo.setIcon(new ImageIcon(Logistica.class.getResource("/icones1_48px/1425606663_image-128.png")));
			labelFotoVeiculo.setForeground(Color.BLACK);
			labelFotoVeiculo.setFont(new Font("Arial", Font.PLAIN, 12));
			...
			labelFundoVeiculo.setIcon(new ImageIcon(Logistica.class.getResource("/papel_parede/(5).png")));
			labelFundoVeiculo.setVerticalAlignment(SwingConstants.TOP);
			labelFundoVeiculo.setBounds(0, 0, 1355, 665);
			...
			labelTelefone2_1.setBounds(178, 564, 80, 32);
			...
			labelCelular1_1.setBounds(456, 564, 69, 32);
			...
			labelCelular2_1.setBounds(317, 564, 80, 32);
			...
			labelFundoMotorista.setIcon(new ImageIcon(Logistica.class.getResource("/papel_parede/(5).png")));
			labelFundoMotorista.setVerticalAlignment(SwingConstants.TOP);
			labelFundoMotorista.setBounds(0, 0, 1355, 667);
			...
			labelFundoTransportadora.setIcon(new ImageIcon(Logistica.class.getResource("/papel_parede/(5).png")));
			...
			labelFundoTransportadora.setBounds(0, 0, 1355, 667);
			...
			labelFundoEntregas.setIcon(new ImageIcon(Logistica.class.getResource("/papel_parede/(5).png")));
			labelFundoEntregas.setVerticalAlignment(SwingConstants.TOP);
			labelFundoEntregas.setBounds(0, 0, 1355, 665);
			panelEntrega.add(labelFundoEntregas);

			tabbedPane.addTab("Veículo",
					new ImageIcon(Logistica.class.getResource("/icones1_24px/1425606739_678100-tachometer-128.png")),panelVeiculo, null);
			tabbedPane.addTab("Motorista",
			            new ImageIcon(Logistica.class.getResource("/icones1_24px/1425606657_user-128.png")),panelMotorista, null);
			tabbedPane.addTab("Transportadora",
			            new ImageIcon(Logistica.class.getResource("/icones1_24px/1425606771_678086-institution-128.png")),panelTransportadora, null);
			tabbedPane.addTab("Entregas ",
					new ImageIcon(Logistica.class.getResource("/icones1_24px/1425606563_map-128.png")),panelEntrega, null);
			tabbedPane.addTab( "Relatórios",
					new ImageIcon(Logistica.class.getResource("/icones1_24px/1425606695_678135-sticky-note-128.png")),panelRelatorios, null);
			...
			menuBar_5.setBounds(579, 0, 196, 32);
			...
			button.setIcon(new ImageIcon(Logistica.class.getResource("/icones1_24px/1425606647_678126-box-in-128.png")));
			...
			btnGrafico.setIcon(new ImageIcon(Logistica.class
			            .getResource("/icones1_24px/1425606754_monitor-128.png")));
			btnGrafico.setFont(new Font("Kalinga", Font.PLAIN, 16));
			...
			label_27.setIcon(new ImageIcon(Logistica.class.getResource("/papel_parede/(5).png")));
			...
			label_27.setBounds(0, 0, 1355, 667);
	...
	protected static void AtualizarFotoVeiculo() {
	...
	protected static void AtualizarFotoMotorista(){
	...
	protected static void SelecionarFotoVeiculo() {
		...
		if (retorno == JFileChooser.APPROVE_OPTION) {
			...
			String comandosql4 = "UPDATE `erp`.`veiculos` SET `imagem` = '" +ModelLogistica.getImagem()
					  + "' WHERE `veiculos`.`codigo` = '" + ModelLogistica.getCodigo1()+ "'";
			x.grava(comandosql4);
			JOptionPane.showMessageDialog(null,"Imagem atualizada com sucesso !!","Atualização", JOptionPane.INFORMATION_MESSAGE);
