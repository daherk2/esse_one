...
public class Suprimentos extends JFrame {
	...
	public static JComboBox<String>   comboNomeFornecedorEst;
	...
	public static JTextField          ieEstoque;
	public static JTextField 		  movimento;
	...
	private static JButton            btDeletarItem;
	...
	static private JButton            salvar, buttonConsultarFornecedor, buttonConsultarEstoque;
	...
	public static  JButton            button_6,button_7,btnPrximo_3;
	...
	public static JRadioButton        rdbtnCadastrarFornecedor;
	public static JRadioButton        rdbtnConsultarFornecedor;
	public static JRadioButton        rdbtnCadastrarMp;
	...
	public static JLabel              piscaTipo;
	...
	static private JLabel             lblOQueGostaria;
	static private JLabel             lblPor_1;
	public static JLabel              piscaTipo2;
	...
	private JLabel                    PIS, ISS, IPI, COFINS, ICMS;
	...
	public static JScrollPane         scrollPane, scrollPane_2,scrollPaneEst;	
	
	static public String codprod, unidade, ficha = "não", tipoConsulta = "",tipoConsulta2 = "", tipoConsulta3 = "", tipoInsereEstoque = "";

	public static int sn = 0, contLinha = 0, tipo, contLinhaEst = 0;
	...
	public Suprimentos() {
		...
		try {
			...
			setIconImage(Toolkit.getDefaultToolkit().getImage(Suprimentos.class.getResource("/logos_solid/SimboloPSemFundo - Copia.png")));
			setName("suprimentos");
			...
			menuArquivo.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606738_678125-folder-house-128.png")));
			...
			menuPrincipal.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606621_678085-house-128.png")));
			menuPrincipal.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					int sair = JOptionPane.showConfirmDialog(null,
							"      Tem certeza que deseja sair?\n"
						  + "Todos os dados não salvos serão perdidos", "Fechamento de Programa",
			...
			menuSair.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/desliga24px.png")));
			...
			menuConfigurao.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606625_678124-wrench-screwdriver-128.png")));
			...
			menuDefinirPapelParede.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606663_image-128.png")));
			...
			menuAbrirBatePapo.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606720_bubbles-alt-128.png")));
			menuAbrirBatePapo.setFont(new Font("Kalinga", Font.PLAIN, 14));
			menuConfigurao.add(menuAbrirBatePapo);

			menuLogout = new JMenu("Logout");
			menuLogout.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606648_678109-profile-group-128.png")));
			...
			menuLogout2.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606718_678075-sign-ban-128.png")));
			menuLogout2.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if(Inicio.caixa.equals("fechado")){
						if (Inicio.mesasAbertas <= 0) {
							int sair = JOptionPane.showConfirmDialog(null, "  Tem certeza que deseja fazer Log-Off ?\n"
						...
						else JOptionPane.showMessageDialog(null, "É necessário fechar o caixa antes de fazer Log-Off!",
								"Atenção", JOptionPane.WARNING_MESSAGE);
			...
			menu.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606602_678131-money-128.png")));
			...
			menuItem.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606821_678065-file-bookmark-128.png")));
			...
			menuAjuda.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606598_678110-sign-info-128.png")));
			...
			menuAbrirAjuda.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606599_678078-light-bulb-128.png")));
			...
			tabbedPaneSuprimentos.setBounds(0, 34, 1360, 705);
			...
			margemLucro.addMouseListener(new MouseAdapter() {

				@Override
				public void mouseEntered(MouseEvent e) {
					if (margemLucro.getText().equalsIgnoreCase("0"))
						margemLucro.setText("");
					margemLucro.requestFocus(true);

				}

				@Override
				public void mouseExited(MouseEvent e) {
					if (margemLucro.getText().equalsIgnoreCase(""))
						margemLucro.setText("0");
					margemLucro.requestFocus(false);
				}
			...
			internalFrame.setFrameIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606795_678095-trashcan-128.png")));
			...
			btCancelar.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606572_678069-sign-error-128.png")));
			...
			btDeletarItem.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/Gnome-edit-clear.png")));
			btDeletarItem.setBounds(9, 100, 140, 35);
			btDeletarItem.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
			...
			tabelaFichaTecnica.getColumnModel().getColumn(0).setCellRenderer(central);
			tabelaFichaTecnica.getColumnModel().getColumn(1).setCellRenderer(central);
			tabelaFichaTecnica.getColumnModel().getColumn(2).setCellRenderer(central);
			tabelaFichaTecnica.getColumnModel().getColumn(3).setCellRenderer(central);
			tabelaFichaTecnica.getColumnModel().getColumn(4).setCellRenderer(central);
			tabelaFichaTecnica.getColumnModel().getColumn(5).setCellRenderer(central);
			tabelaFichaTecnica.getColumnModel().getColumn(6).setCellRenderer(central);
			...
			quantidade.addMouseListener(new MouseAdapter() {
				@Override
				public void mouseEntered(MouseEvent e) {
					if (quantidade.getText().equalsIgnoreCase("0"))
						quantidade.setText("");
					quantidade.requestFocus(true);

				}
				@Override
				public void mouseExited(MouseEvent e) {
					if (quantidade.getText().equalsIgnoreCase(""))
						quantidade.setText("0");
					quantidade.requestFocus(false);
				}
			...
			precoCusto.addMouseListener(new MouseAdapter() {
				@Override
				public void mouseEntered(MouseEvent e) {
					if (precoCusto.getText().equalsIgnoreCase("0,00"))
						precoCusto.setText("");
					precoCusto.requestFocus(true);
				}

				@Override
				public void mouseExited(MouseEvent e) {
					if (precoCusto.getText().equalsIgnoreCase(""))
						precoCusto.setText("0,00");
					precoCusto.requestFocus(false);
				}
			});
			...
			precoVenda.addMouseListener(new MouseAdapter() {

				@Override
				public void mouseEntered(MouseEvent e) {
					if (precoVenda.getText().equalsIgnoreCase("0,00"))
						precoVenda.setText("");
					precoVenda.requestFocus(true);

				}

				@Override
				public void mouseExited(MouseEvent e) {
					if (precoVenda.getText().equalsIgnoreCase(""))
						precoVenda.setText("0,00");
					precoVenda.requestFocus(false);
				}
			...
			comboBox_2.setBounds(906, 61, 131, 32);
			...
			rdbtnCadastrarProduto.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					SuprimentosController.SetarBordaProdNull();
			...
			rdbtnConsultarProduto.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					caminho.setText("");
					PIS.setVisible(true);
					ISS.setVisible(true);
					...
					consultarProduto.setEnabled(true);
			...
			fichaSim.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
			...
			fichaNao.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					fichaNao.setSelected(true);
					fichaSim.setSelected(false);
			...
			menuBar_1.setBounds(257, 1, 844, 32);
			...
			salvar.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606570_floppy-128.png")));
			...
			consultarProduto.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606561_search-128.png")));
			...
			btnCancelar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					btnAtualizr.setEnabled(false);
					Suprimentos.SetarProdutoNaoEditavel();
					Suprimentos.limparProduto();
				}
			});
			btnCancelar.setToolTipText("alt + Delete");
			btnCancelar.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606572_678069-sign-error-128.png")));
			...
			btnCancelar.setAlignmentX(0.5f);
						...
						btnAtualizr.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent arg0) {
								SuprimentosController.AtualizarProduto();
							}
						});
						btnAtualizr.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606696_678121-cloud-sync-128.png")));
			...
			limpar.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/Gnome-edit-clear.png")));
			...
			AlterarProduto.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					estoqueMinimo1.setValue(Integer.parseInt(estoqueminconsulta.getText()));
					btnAtualizr.setEnabled(true);
			...
			button_1.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606647_678126-box-in-128.png")));
			...
			btnAnterior.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425605893_arrow_left.png")));
			...
			btnAnterior.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					SuprimentosController.ConsultarProdAnterior();
				}
			});
			...
			btnProximo.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					SuprimentosController.ConsultarProxProd();
				}
			});
			btnProximo.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425605875_arrow_right.png")));
			...
			btnAddItem.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606548_678092-sign-add-128.png")));
			...
			btnRemItem.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606572_678069-sign-error-128.png")));
			...
			btImagem.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606659_678090-camera-128.png")));
			...
			btnCalcular.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606619_notepad-128.png")));
			...
			atualizarImagem.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
			...
			labelFotoProduto.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_48px/1425606804_pic-128.png")));
			...
			lblAdicionarImposto.setHorizontalAlignment(SwingConstants.CENTER);
			lblAdicionarImposto.setForeground(Color.BLACK);
			lblAdicionarImposto.setFont(new Font("Kalinga", Font.BOLD, 14));
			lblAdicionarImposto.setBounds(1126, 134, 160, 32);
			...
			label_19.setBounds(1034, 116, 299, 528);
			...
			label_20.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "VALORES DO PRODUTO", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(0, 0, 0)));
			...
			label_9.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null,null), "SELECIONAR A\u00C7\u00C3O", TitledBorder.CENTER,
			...
			PIS.setVisible(false);
			PIS.setOpaque(false);
			PIS.setHorizontalAlignment(SwingConstants.CENTER);
			PIS.setForeground(Color.BLACK);
			PIS.setFont(new Font("Dialog", Font.PLAIN, 14));
			PIS.setBounds(1079, 177, 84, 32);
			panelCadastrarProduto.add(PIS);

			ISS = new JLabel("ISS");
			ISS.setVisible(false);
			ISS.setOpaque(false);
			ISS.setHorizontalAlignment(SwingConstants.CENTER);
			ISS.setForeground(Color.BLACK);
			ISS.setFont(new Font("Dialog", Font.PLAIN, 14));
			ISS.setBounds(1079, 213, 84, 32);
			panelCadastrarProduto.add(ISS);

			IPI = new JLabel("IPI");
			IPI.setVisible(false);
			IPI.setOpaque(false);
			IPI.setHorizontalAlignment(SwingConstants.CENTER);
			IPI.setForeground(Color.BLACK);
			IPI.setFont(new Font("Dialog", Font.PLAIN, 14));
			IPI.setBounds(1075, 249, 84, 32);
			panelCadastrarProduto.add(IPI);

			COFINS = new JLabel("COFINS");
			COFINS.setVisible(false);
			COFINS.setOpaque(false);
			COFINS.setHorizontalAlignment(SwingConstants.CENTER);
			COFINS.setForeground(Color.BLACK);
			COFINS.setFont(new Font("Dialog", Font.PLAIN, 14));
			COFINS.setBounds(1091, 285, 84, 32);
			panelCadastrarProduto.add(COFINS);

			ICMS = new JLabel("ICMS");
			ICMS.setVisible(false);
			ICMS.setOpaque(false);
			ICMS.setHorizontalAlignment(SwingConstants.CENTER);
			ICMS.setForeground(Color.BLACK);
			ICMS.setFont(new Font("Dialog", Font.PLAIN, 14));
			ICMS.setBounds(1081, 321, 84, 32);
			panelCadastrarProduto.add(ICMS);

			labelFundoProduto = new JLabel("");
			labelFundoProduto.setIcon(new ImageIcon(Suprimentos.class.getResource("/papel_parede/(6).png")));
			labelFundoProduto.setOpaque(true);
			...
			labelFundoProduto.setBounds(0, 0, 1358, 669);
			...
			comboDesejaAdicionar.addItemListener(new ItemListener() {
				public void itemStateChanged(ItemEvent evt) {
					...
					if (tipo == 1) {
						try {
							...
							while (rs11.next()) {
								...
								precoUnidadeEst.setText(rs11.getString("precoVenda"));
								estoqueAtual.setText(rs11.getString("estoqueAtual"));
								estoqueMinimoEst.setText(rs11.getString("estoqueMinimo"));
								unidadeEst.setText(rs11.getString("unidade"));
								descricaoEst.setText(rs11.getString("descricaoProduto"));
								ImageIcon imagem = new ImageIcon((rs11.getString("imagem").replace("~","\\")));Image img = imagem.getImage().getScaledInstance(
								            155, 115, Image.SCALE_AREA_AVERAGING);
								labelFotoEstoque.setIcon(new javax.swing.ImageIcon(img));
								labelFotoEstoque.setText("");
								if (rs11.getString("fichaTecnica").equals("sim")) {
									ResultSet dados2 = x.Consultar("select*from fichatecnica where codigoproduto = '"+ rs11.getString("codigoProduto")
									            + "'");
									while (dados2.next()) {
					...
					if (tipo == 2) {
						try {
							String sql11 = "select * from materia_p where nome = '"+ item.toString() + "'";
							ResultSet rs11 = x.Consultar(sql11);
							while (rs11.next()) {
								codigoEst.setText(rs11.getString("codigo"));
								precoUnidadeEst.setText(rs11.getString("precoUnidade"));
								estoqueAtual.setText(rs11.getString("estoqueAtual"));
								estoqueMinimoEst.setText(rs11.getString("estoqueMinimo"));
								unidadeEst.setText(rs11.getString("unidade"));
								descricaoEst.setText(rs11.getString("descricaoMateriaPrima"));
								ImageIcon imagem = new ImageIcon((rs11.getString("imagem").replace("~","\\")));
			...
			precoUnidadeEst.addKeyListener(new java.awt.event.KeyAdapter() {
				public void keyReleased(java.awt.event.KeyEvent evt) {
					//precoUnidadeEst.setText(precoUnidadeEst.getText().replaceAll("[^0-9]", ""));
					// precoUnidadeEst.setText(precoUnidadeEst.getText().replaceAll("[^A-Z | ^a-z]",
					// ""));
				}
			});
			precoUnidadeEst.addMouseListener(new MouseAdapter() {
				@Override
				public void mouseEntered(MouseEvent e) {
					if (precoUnidadeEst.getText().equalsIgnoreCase("0,00"))
						precoUnidadeEst.setText("");
					precoUnidadeEst.requestFocus(true);
				}
				@Override
				public void mouseExited(MouseEvent e) {
					if (precoUnidadeEst.getText().equalsIgnoreCase(""))
						precoUnidadeEst.setText("0,00");
					precoUnidadeEst.requestFocus(false);
				}
			});
			...
			estoqueMinimoEst.addKeyListener(new java.awt.event.KeyAdapter() {
				public void keyReleased(java.awt.event.KeyEvent evt) {
					estoqueMinimoEst.setText(estoqueMinimoEst.getText().replaceAll("[^0-9]", ""));
			...
			notaFiscalEst.addKeyListener(new java.awt.event.KeyAdapter() {
				public void keyReleased(java.awt.event.KeyEvent evt) {
					notaFiscalEst.setText(notaFiscalEst.getText().replaceAll("[^0-9]", ""));
			...
			comboLocalEstoque4.addItem("Geladeira");
			comboLocalEstoque4.addItem("Estufa");
			...
			quantidadeAdicionada.addKeyListener(new java.awt.event.KeyAdapter() {
				public void keyReleased(java.awt.event.KeyEvent evt) {
					quantidadeAdicionada.setText(quantidadeAdicionada.getText().replaceAll("[^0-9]", ""));
			...
			quantidadeAdicionada.setBounds(797, 253, 112, 32);
			panelAddproduto.add(quantidadeAdicionada);

			comboNomeFornecedorEst = new JComboBox<String>();
			comboNomeFornecedorEst.setForeground(Color.BLACK);
			comboNomeFornecedorEst.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
			comboNomeFornecedorEst.setFont(new Font("SansSerif", Font.PLAIN, 14));
			comboNomeFornecedorEst.setBounds(363, 354, 285, 32);
			panelAddproduto.add(comboNomeFornecedorEst);
			comboNomeFornecedorEst.addItem("");
			comboNomeFornecedorEst.addItemListener(new ItemListener() {
				public void itemStateChanged(ItemEvent evt) {
					Object item = evt.getItem();
					String sql11 = "select * from fornecedor where nome = '"+ item.toString() + "'";
					ResultSet rs11 = x.Consultar(sql11);
					
					try {
						rs11.next();
						codigoFornecedorEst.setText(rs11.getString("codigoFornecedor"));
						Suprimentos.ieEstoque.setText(rs11.getString("inscricaoEstadual"));	
					}
			...
			codigoFornecedorEst.addKeyListener(new java.awt.event.KeyAdapter() {
				public void keyReleased(java.awt.event.KeyEvent evt) {
					codigoFornecedorEst.setText(codigoFornecedorEst.getText().replaceAll("[^0-9]", ""));
			...
			movimento = new JTextField();
			movimento.setVisible(false);
			movimento.setEditable(false);
			movimento.setSelectionColor(SystemColor.textHighlight);
			movimento.setHorizontalAlignment(SwingConstants.CENTER);
			movimento.setForeground(Color.BLACK);
			movimento.setFont(new Font("Kalinga", Font.PLAIN, 14));
			movimento.setDisabledTextColor(Color.BLACK);
			movimento.setColumns(10);
			movimento.setBounds(921, 253, 116, 32);
			panelAddproduto.add(movimento);
			
			JLabel lblMovimento = new JLabel("Movimento");
			lblMovimento.setVisible(false);
			
			usuario = new JTextField();
			usuario.setVisible(false);
			usuario.setEditable(false);
			usuario.setSelectionColor(SystemColor.textHighlight);
			usuario.setHorizontalAlignment(SwingConstants.CENTER);
			usuario.setForeground(Color.BLACK);
			usuario.setFont(new Font("Kalinga", Font.PLAIN, 14));
			usuario.setDisabledTextColor(Color.BLACK);
			usuario.setColumns(10);
			usuario.setBounds(1049, 253, 112, 32);
			panelAddproduto.add(usuario);
			lblMovimento.setForeground(Color.BLACK);
			lblMovimento.setFont(new Font("Kalinga", Font.BOLD, 14));
			lblMovimento.setBounds(921, 221, 116, 32);
			panelAddproduto.add(lblMovimento);

			JScrollPane scrollPane_3 = new JScrollPane();
			scrollPane_3.setBorder(new TitledBorder(null, "", TitledBorder.LEADING,TitledBorder.TOP, null, null));
			...
			descricaoEst.addKeyListener(new java.awt.event.KeyAdapter() {
				public void keyReleased(java.awt.event.KeyEvent evt) {
					...
					descricaoEst.setText(descricaoEst.getText().replaceAll("[^A-Z | ^a-z]", ""));
				}
			});
			...
			scrollPaneEst = new JScrollPane();
			scrollPaneEst.setVisible(false);
			scrollPaneEst.setBorder(new TitledBorder(null, "", TitledBorder.LEADING,TitledBorder.TOP, null, null));
			...
			tabelaFichaTecnica2.setModel(new DefaultTableModel(new Object[][] { { null, null,null, null, null, null, null }, },
			            new String[] { "N\u00BA Item", "Cod MP", "Nome", "Unidade","Pre\u00E7o", "Quant.", "Custo Agregado" }));
			...
			tabelaFichaTecnica2.setBackground(new Color(220, 220, 220));
			...
			radioProduto.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					Suprimentos.button_6.setEnabled(false);
					Suprimentos.button_7.setEnabled(false);
					Suprimentos.btnPrximo_3.setEnabled(false);
					tipo = 1;
					sn = 1;
					if (sn == 1) {
						...
						ResultSet rs = x.Consultar(sql);
						try {
							comboDesejaAdicionar.setFont(new Font("Tahoma",Font.PLAIN, 14));
							comboDesejaAdicionar.setEditable(false);
							if (Inicio.rd == 0) {
								comboDesejaAdicionar.addItem("");
								while (rs.next()) {
									comboDesejaAdicionar.addItem(rs.getString("nome"));
								}
							}
						}
						catch (SQLException ex) {
						...
						comboNomeFornecedorEst.removeAllItems();						
						String sql10 = "select * from fornecedor order by nome";
						ResultSet rs10 = x.Consultar(sql10);
						try {
							comboNomeFornecedorEst.addItem("");
							while (rs10.next()) {
								comboNomeFornecedorEst.addItem(rs10.getString("nome"));
							}
							if (rdbtnConsultarEstoque.isSelected() == true) {
								comboNomeFornecedorEst.setVisible(false);
							}
						}
						catch (SQLException ex) {
							ex.printStackTrace();
			...
			radioNovo.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					comboNomeFornecedorEst.setVisible(false);
					comboNomeFornecedorEst.setSelectedItem("");
				}
			});
			...
			rdbtnCadastrar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					dataEntrada.setText(formato.format(data));
					buttonConsultarEstoque.setEnabled(false);
					buttonSalvarEst.setEnabled(true);
			...
			rdbtnCadastrar.setBounds(427, 61, 203, 32);
			panelAddproduto.add(rdbtnCadastrar);

			rdbtnConsultarEstoque = new JRadioButton("Consultar Movimentação Estoque");
			rdbtnConsultarEstoque.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
			rdbtnConsultarEstoque.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					Suprimentos.limparEstoque();
					...
					dataEntrada.setText("");
					buttonConsultarEstoque.setEnabled(true);
					buttonSalvarEst.setEnabled(false);
					...
					comboNomeFornecedorEst.setSelectedItem("");
					nomeEst.setVisible(true);
					lblMovimento.setVisible(true);
					movimento.setVisible(true);
					lblUsurio.setVisible(true);
					usuario.setVisible(true);
					SuprimentosController.SetarBordaEstNull();
				}
			});
			...
			rdbtnConsultarEstoque.setBounds(623, 61, 269, 32);
			...
			radioButton.setBounds(937, 66, 101, 23);
			...
			rdbtnNome.setBounds(1033, 66, 89, 23);
			panelAddproduto.add(rdbtnNome);

			menuBar_4 = new JMenuBar();
			menuBar_4.setBounds(389, 0, 579, 32);
			...
			buttonSalvarEst.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
			...
			buttonConsultarEstoque.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (radioMateriaPrima.isSelected() == false && radioProduto.isSelected() == false) {
						Toolkit.getDefaultToolkit().beep();
						JOptionPane.showMessageDialog(null,"Selecione o que gostaria de consultar.","Atenção", JOptionPane.WARNING_MESSAGE);
						piscaTipo.setVisible(true);
					}
					else if (radioButton.isSelected() == false && rdbtnNome.isSelected() == false) {
						Toolkit.getDefaultToolkit().beep();
						JOptionPane.showMessageDialog(null,"Selecione o parametro da consulta.", "Atenção",JOptionPane.WARNING_MESSAGE);
			...
			button_7.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if(radioProduto.isSelected()==true)SuprimentosController.ConsultarProdAntEstoque();
					else SuprimentosController.ConsultarMPAntEstoque();
				}
			});
			...
			btnPrximo_3 = new JButton("Pr\u00F3ximo");
			btnPrximo_3.setEnabled(false);
			...
			btnPrximo_3.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if(radioProduto.isSelected()==true)	SuprimentosController.ConsultarProxProdEstoque();
					else SuprimentosController.ConsultarProxMPEstoque();
				}
			});
			...
			lblDataDaEntrada.setBounds(761, 149, 120, 32);
			...
			labelCodigo.setBounds(26, 221, 80, 32);
			...
			labelValidade.setBounds(1018, 149, 80, 32);
			...
			labelNotaFiscal.setBounds(280, 221, 80, 32);
			...
			labelUnidade.setBounds(670, 221, 80, 32);
			panelAddproduto.add(labelUnidade);

			labelLocalEstoque = new JLabel("Local");
			...
			labelLocalEstoque.setBounds(463, 221, 124, 32);
			...
			labelDataCompra.setBounds(888, 149, 120, 32);
			...
			labelNumeroLote.setBounds(153, 221, 80, 32);
			...
			labelFotoEstoque.setBounds(1173, 183, 145, 95);
			...
			labelFornecedor.setBounds(53, 356, 90, 26);
			...
			labelQuantidade = new JLabel("Quant. á Adic.");
			...
			labelQuantidade.setBounds(797, 221, 117, 32);
			...
			lblOQueGostaria.setBounds(292, 96, 249, 32);
			...
			lblPor_1.setBounds(895, 62, 49, 32);
			...
			piscaTipo2.setBounds(944, 66, 172, 23);
			...
			lblIe.setBounds(816, 327, 145, 26);
			panelAddproduto.add(lblIe);
			
			lblUsurio = new JLabel("Usuário");
			lblUsurio.setVisible(false);
			lblUsurio.setForeground(Color.BLACK);
			lblUsurio.setFont(new Font("Kalinga", Font.BOLD, 14));
			lblUsurio.setBounds(1049, 221, 112, 32);
			panelAddproduto.add(lblUsurio);

			label_30 = new JLabel("");
			label_30.setForeground(Color.BLACK);
			label_30.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 15));
			label_30.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null,
			            null), "DADOS DO ITEM \u00C1 SER ADICIONADO", TitledBorder.LEFT,
			...
			label_31.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null,
			            null), "DADOS FORNECEDOR", TitledBorder.LEFT, TitledBorder.TOP, null,
			            Color.BLACK));
			...
			label_33.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null,
			            null), "INFORMA\u00C7\u00D5ES COMPLEMENTARES", TitledBorder.LEFT,
			            TitledBorder.TOP, null, Color.BLACK));
			...
			label.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null,
			...
			labelFundoEstoque.setOpaque(true);
			...
			labelFundoEstoque.setBounds(0, 0, 1355, 667);
			panelAddproduto.add(labelFundoEstoque);
			labelFundoEstoque.setIcon(new ImageIcon(Suprimentos.class.getResource("/papel_parede/(6).png")));
			...
			comboBox_3.setBounds(894, 78, 131, 32);
			...
			rdbtnCadastrarMp.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					SuprimentosController.SetarBordaMPNull();
					
					rdbtnCadastrarMp.setSelected(true);
					rdbtnConsultarMP.setSelected(false);
					salvarMP.setEnabled(true);
					nome2.setEnabled(true);
					labelFotoMateriaPrima.setText("imagem");
					labelFotoMateriaPrima.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_48px/1425606663_image-128.png")));
					btnImagem.setVisible(true);
					atualizarImagemMP.setVisible(false);
					buttonConsultarMateriaPrima.setEnabled(false);
					codigo2.setEnabled(false);
			...
			rdbtnConsultarMP.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					buttonConsultarMateriaPrima.setEnabled(true);
					Suprimentos.limparMP();
			...
			codigo2.setBounds(31, 200, 173, 32);
			...
			nome2.setColumns(10);
			nome2.setBounds(214, 200, 381, 32);
			...
			localEstoque.setBounds(605, 200, 140, 32);
			...
			comboBox_4.setBounds(755, 200, 172, 32);
			...
			tipoConsultaMP.setBounds(755, 200, 173, 32);
			...
			comboUnidade2.setBounds(31, 275, 131, 32);
			...
			unidadeconsulta2.setBounds(31, 275, 131, 32);
			...
			numeroLote2.setBounds(171, 275, 173, 32);
			...
			estoqueMinimo2.setBounds(364, 275, 81, 32);
			...
			estoqueMinimoConsulta2.setBounds(364, 275, 81, 32);
			...
			precoPor2.addMouseListener(new MouseAdapter() {

				@Override
				public void mouseEntered(MouseEvent e) {
					if (precoPor2.getText().equalsIgnoreCase("0,00"))
						precoPor2.setText("");
					precoPor2.requestFocus(true);

				}

				@Override
				public void mouseExited(MouseEvent e) {
					if (precoPor2.getText().equalsIgnoreCase(""))
						precoPor2.setText("0,00");
					precoPor2.requestFocus(false);
				}
			...
			precoPor2.setBounds(484, 275, 192, 32);
			panelCadastrarMateriaPrima.add(precoPor2);

			menuBar_2 = new JMenuBar();
			menuBar_2.setBounds(257, 1, 844, 32);
			...
			salvarMP.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
			...
			salvarMP.setIcon(new ImageIcon(Suprimentos.class
						...
						buttonConsultarMateriaPrima.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
			...
			btnAtualizar.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606696_678121-cloud-sync-128.png")));
			...
			button_11.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					estoqueMinimo2.setValue(Integer.parseInt(estoqueMinimoConsulta2.getText()));
					Suprimentos.SetarMpEditavel();
					nome2.setEditable(true);
			...
			btnAnterior2.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					SuprimentosController.ConsultarMPAnterior();
				}
			});
			...
			btnProximo2.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425605875_arrow_right.png")));
			...
			btnProximo2.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					SuprimentosController.ConsultarProxMP();
				}
			});
			...
			btnImagem.setBounds(1007, 299, 145, 35);
			...
			atualizarImagemMP.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606696_678121-cloud-sync-128.png")));
			atualizarImagemMP.setForeground(Color.BLACK);
			atualizarImagemMP.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
			...
			atualizarImagemMP.setBounds(1007, 299, 145, 35);
			...
			scrollPane_2.setBounds(31, 351, 943, 59);
			...
			lblPor2.setBounds(845, 78, 49, 32);
			...
			lblNDoLote.setBounds(171, 243, 80, 32);
			...
			lblNotaFiscal.setBounds(755, 168, 80, 32);
			...
			lblUnidade_1.setBounds(31, 243, 80, 32);
			...
			lblLocalDeEstoque.setBounds(605, 168, 131, 32);
			...
			labelFotoMateriaPrima.setBounds(1007, 200, 145, 95);
			...
			lblPreo.setBounds(484, 243, 86, 32);
			...
			lblEstoqueMinimo.setBounds(354, 243, 120, 32);
			...
			lblUnidade.setBounds(558, 243, 80, 32);
			...
			lblDescrio_1.setBounds(31, 318, 80, 32);
			...
			label_26.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null,
			            null), "DADOS DA MAT\u00C9RIA PRIMA", TitledBorder.LEFT,
			            TitledBorder.TOP, null, Color.BLACK));
			label_26.setBounds(10, 140, 1331, 506);
			...
			labelFundoMateriaPrima.setOpaque(true);
			...
			labelFundoMateriaPrima.setBounds(0, 0, 1351, 667);
			labelFundoMateriaPrima.setIcon(new ImageIcon(Suprimentos.class.getResource("/papel_parede/(6).png")));
			...
			rdbtnCadastrarFornecedor.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
			rdbtnCadastrarFornecedor.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					buttonConsultarFornecedor.setEnabled(false);
					...
					SuprimentosController.SetarBordaFornNull();
			...
			rdbtnConsultarFornecedor.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
			rdbtnConsultarFornecedor.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					buttonConsultarFornecedor.setEnabled(true);
					SuprimentosController.SetarBordaFornNull();
			...
			menuBar_3.setBounds(256, 1, 845, 32);
			...
			button_4.setFont(new Font("Kalinga", Font.PLAIN, 14));
						...
						buttonConsultarFornecedor.addActionListener(new ActionListener() {
							public void actionPerformed(ActionEvent e) {
			...
			btnAtualizar_1.setEnabled(false);
			...
			btnAtualizar_1.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606696_678121-cloud-sync-128.png")));
			...
			btnCancelar_2.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					btnAtualizar_1.setEnabled(false);
					btnCancelar_2.setEnabled(false);
					SetarFornNaoEditavel();					
				 }
			});
			btnCancelar_2.setToolTipText("alt + Delete");
			btnCancelar_2.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606572_678069-sign-error-128.png")));
			...
			btnLimpar.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/Gnome-edit-clear.png")));
			...
			button_13.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					btnAtualizar_1.setEnabled(true);
			...
			buttonAnteriorF.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425605893_arrow_left.png")));
			...
			buttonAnteriorF.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					SuprimentosController.ConsultarFornAnterior();
				}
			});
			...
			btnPrximoF.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425605875_arrow_right.png")));
			btnPrximoF.setMnemonic(KeyEvent.VK_P);
			btnPrximoF.setFont(new Font("Kalinga", Font.PLAIN, 14));
			btnPrximoF.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					SuprimentosController.ConsultarProxForn();
				}
			});
			...
			button_atualizarImagemForn.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
			...
			label_28.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null,
			            null), "DADOS FORNECEDOR", TitledBorder.LEFT, TitledBorder.TOP, null,
			            Color.BLACK));
			...
			label_29.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null,
			            null), "ENDERE\u00C7O FORNECEDOR", TitledBorder.LEFT,
			            TitledBorder.TOP, null, Color.BLACK));
			...
			labelFundoFornecedor.setIcon(new ImageIcon(Suprimentos.class.getResource("/papel_parede/(6).png")));
			labelFundoFornecedor.setVerticalAlignment(SwingConstants.TOP);
			labelFundoFornecedor.setBounds(0, 0, 1351, 667);
			panelFornecedor.add(labelFundoFornecedor);

			caminho3 = new JTextField();
			caminho3.setColumns(10);
			caminho3.setBounds(28, 600, 122, 32);
			...
			menuBar_6.setBounds(586, 0, 186, 32);
			...
			button_9.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					JFreeChart chart = ChartFactory.createPieChart3D("Qt. de Produtos",pieDataset, true, true, true);
			...
			button_10 = new JButton("Imprimir");
			button_10.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606647_678126-box-in-128.png")));
			button_10.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {

				}
			});
			button_10.setToolTipText("alt + P");
			button_10.setMnemonic(KeyEvent.VK_P);
			button_10.setFont(new Font("Kalinga", Font.PLAIN, 14));
			menuBar_6.add(button_10);
			...
			label_50.setIcon(new ImageIcon(Suprimentos.class.getResource("/papel_parede/(6).png")));
			...
			label_50.setBounds(0, 0, 1355, 667);
			panelRelatorios.add(label_50);

					tabbedPaneSuprimentos.addTab("Produto ",
		               new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606650_678112-bag-128.png")),panelCadastrarProduto, null);
					tabbedPaneSuprimentos.addTab("Matéria Prima ",
					   new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606655_file-powerpoint-128.png")),panelCadastrarMateriaPrima, null);
					tabbedPaneSuprimentos.addTab("Fornecedor ",
				       new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606601_book-128.png")),panelFornecedor, null);
					tabbedPaneSuprimentos.addTab(" Estoque ",
					   new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606821_678065-file-bookmark-128.png")),panelAddproduto, null);
					tabbedPaneSuprimentos.addTab("Relatórios",
					   new ImageIcon(Suprimentos.class.getResource("/icones1_24px/1425606695_678135-sticky-note-128.png")),panelRelatorios, null);
	...
	// <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
	// Produto
	public static void SetarProdutoNaoEditavel() {
	...
	public static void limparMP() {
		...
		numeroLote2.setText("");
		tipoConsultaMP.setText("");
		comboBox_4.setSelectedItem("");
		comboUnidade2.setSelectedItem("");
		localEstoque.setText("");
		descricaoMateriaPrima2.setText("");
		comboBox_3.setSelectedItem("");
		precoPor2.setText("");
		estoqueMinimo2.setValue(1);
		unidadeconsulta2.setText("");
		estoqueMinimoConsulta2.setText("");
		codigo2.setEnabled(false);
		Suprimentos.atualizarImagemMP.setVisible(false);
		labelFotoMateriaPrima.setText("imagem");
		labelFotoMateriaPrima.setIcon(new ImageIcon(Suprimentos.class
		            .getResource("/icones1_48px/1425606663_image-128.png")));
	}
	...
	public static void limparFornecedor() {
		...
		Suprimentos.button_atualizarImagemForn.setVisible(false);
		labelFotoFornecedor.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_32px/1425606663_image-128.png")));
	...
	public static void limparEstoque() {
		...
		labelFotoEstoque.setIcon(new ImageIcon(Suprimentos.class.getResource("/icones1_48px/1425606663_image-128.png")));
