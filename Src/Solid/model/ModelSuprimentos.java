...
public class ModelSuprimentos {
	...
	protected void setPrecoMp(String precoMp) {
		Suprimentos.modeloficha.setValueAt((String.valueOf(precoMp).replace(",", ".")), linha,
				4);
	}
	...
	public static void setQuantMp(String quantMp) {
		Suprimentos.modeloficha.setValueAt((String.valueOf(quantMp).replace(",", ".")), linha,
				5);
	}
	...
	public static void setCustoAgregado(String custoAgregado) {
		Suprimentos.modeloficha.setValueAt((String.valueOf(custoAgregado).replace(",", ".")),
				linha, 6);
	}
