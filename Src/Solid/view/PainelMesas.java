...
class PainelMesas extends JFrame {
	...
	protected PainelMesas() {
		...
		try {
			...
			menuSair.setIcon(new ImageIcon(PainelMesas.class
			...
			tabbedPaneVendas.setBounds(0, 33, 1356, 695);
			...
			Quantidade2.setForeground(Color.BLACK);
			Quantidade2.setFont(new Font("Kalinga", Font.PLAIN, 14));
			Quantidade2.setModel(new SpinnerNumberModel(new Integer(1), null, null,
					new Integer(5)));
			Quantidade2.setBounds(176, 60, 70, 32);
			internalFrameRemove.getContentPane().add(Quantidade2);
			btCancelar.setIcon(new ImageIcon(PainelMesas.class
			...
			btRemoverItem_1.setIcon(new ImageIcon(PainelMesas.class
			...
			Tabela_itens.setBackground(Color.WHITE);
			...
			numeroVenda.setForeground(Color.BLACK);
			numeroVenda.setSelectionColor(SystemColor.textHighlight);
			...
			ultimoPedido.setForeground(Color.BLACK);
			ultimoPedido.setSelectionColor(SystemColor.textHighlight);
			...
			comboNome.setForeground(Color.BLACK);
			...
			telefone.setSelectionColor(SystemColor.textHighlight);
			try {
			...
			numeroCheque.setForeground(Color.BLACK);
			numeroCheque.setSelectionColor(SystemColor.textHighlight);
			...
			numeroConta.setSelectionColor(SystemColor.textHighlight);
			...
			valorTotal.setSelectionColor(SystemColor.textHighlight);
			valorTotal.setForeground(Color.BLACK);
			...
			valorTotal.setBounds(868, 423, 150, 32);
			valorTotal.setText("0.00");
			panelPainelVendas.add(valorTotal);
			
			desconto = new JTextField();
			desconto.setSelectionColor(SystemColor.textHighlight);
			desconto.setForeground(Color.BLACK);
			...
			desconto.setBounds(868, 498, 150, 32);
			desconto.setText("0.00");
			panelPainelVendas.add(desconto);
			
			valorFinal = new JTextField();
			valorFinal.setSelectionColor(SystemColor.textHighlight);
			valorFinal.setForeground(Color.BLACK);
			...
			valorFinal.setBounds(1180, 573, 150, 32);
			valorFinal.setText("0.00");
			panelPainelVendas.add(valorFinal);
			
			valorParcelado = new JTextField();
			valorParcelado.setEditable(false);
			valorParcelado.setSelectionColor(SystemColor.textHighlight);
			valorParcelado.setForeground(Color.BLACK);
			...
			valorParcelado.setBounds(868, 573, 150, 32);
			panelPainelVendas.add(valorParcelado);
			
			valorPago = new JTextField();
			valorPago.setSelectionColor(SystemColor.textHighlight);
			valorPago.setForeground(Color.BLACK);
			...
			valorPago.setBounds(1180, 423, 150, 32);
			...
			troco1.setText("0.00");
			troco1.setBounds(1180, 498, 150, 32);
			...
			radioPrazo.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					if (opc == 1) {
						...
						valorParcelado.setText(comboVezes.getSelectedItem().toString()
								+ " " + valorFinal.getText());
					}
				}
			});
			...
			menuBar_1.setBounds(457, 0, 437, 32);
			panelPainelVendas.add(menuBar_1);
			
			btFecharMesa = new JButton("Salvar");
			btFecharMesa.setForeground(Color.BLACK);
			...
			btnCancelar.setIcon(new ImageIcon(PainelMesas.class
					.getResource("/icones1_24px/1425606572_678069-sign-error-128.png")));
			...
			btCancelarVenda.setForeground(Color.BLACK);
			...
			btCancelarVenda.setIcon(new ImageIcon(PainelMesas.class
					.getResource("/icones1_24px/Gnome-edit-clear.png")));
			...
			btOcultarPainel.setForeground(Color.BLACK);
			...
			btRecalcularTroco.setBounds(1031, 594, 129, 30);
			...
			labelValorPago.setBounds(1180, 391, 120, 32);
			...
			labelValorTotal.setBounds(868, 391, 150, 32);
			...
			labelValorParcelado.setBounds(868, 541, 160, 32);
			...
			labelSelecioneCartao.setForeground(Color.BLACK);
			...
			labelAgencia.setBounds(970, 260, 56, 32);
			...
			labelNumeroConta.setBounds(962, 303, 64, 32);
			...
			labelBanco.setBounds(970, 175, 56, 32);
			...
			labelNumeroCheque.setBounds(946, 217, 80, 32);
			...
			labelUltimoPedido.setForeground(Color.BLACK);
			...
			labelAnimacao.setBorder(new TitledBorder(null, "", TitledBorder.LEADING,
					TitledBorder.TOP, null, null));
			labelAnimacao.setHorizontalAlignment(SwingConstants.CENTER);
			labelAnimacao.setForeground(Color.BLACK);
			...
			labelMesaX.setForeground(Color.BLACK);
			...
			labelFundoPainelMesas.setForeground(Color.BLACK);
			...
			labelFundoPainelMesas.setIcon(new ImageIcon(PainelMesas.class
					.getResource("/papel_parede/blank.png")));
			labelFundoPainelMesas.setBounds(0, 0, 1359, 646);
			...
			tabbedPaneVendas.addTab("Painel de Vendas ", new ImageIcon(PainelMesas.class
					.getResource("/icones1_24px/1425606608_pencil-128.png")),
					panelPainelVendas, null);
			
			contitem = new JTextField();
			contitem.setForeground(Color.BLACK);
			...
			java.util.logging.Logger.getLogger(PainelMesas.class.getName()).log(
	...
	protected void CancelarVenda() {
		if (contLinha > 0) {
			String comandosql7 = "UPDATE `erp`.`mesas` SET " + " `numeroVenda` = '" + null
					+ "', `data` = '" + null + "', `ultimoPedido` = '" + null
					+ "', `vendedor` = '" + null + "', `nomeCliente` = '" + null
					+ "', `cpf` = '" + null + "', `telefone` = '" + null
					+ "', `formaPagamento` = '" + null + "', `quantidade` = '" + null
					+ "', `valorTotal` = '" + null + "', `desconto` = '" + null
					+ "', `valorFinal` = '" + null + "', `valorParcelado` = '" + null
					+ "', `valorPago` = '" + null + "', `status` = '" + "Final"
					+ "', `motivo` = '" + "cancelada" + "'WHERE `mesas`.`numeroMesa` = '"
					+ labelMesaX.getText() + "'";
	...
	private void RemoverItem() {
		...
		if (this.comboRemoveItem.getSelectedItem().toString().equals("")) {
			...
			if (this.contLinha == 1) {
				if ((Integer) this.Quantidade2.getValue() > Integer
						.parseInt((String) this.modelo.getValueAt(contLinha - 1, 3))) {
				...
				if ((Integer) this.Quantidade2.getValue()
						- Integer.parseInt((String) this.modelo.getValueAt(
								this.contLinha - 1, 3)) == 0
						&& this.M == 0) {
					this.contLinha--;
					...
					for (int i = 0; i < this.contLinha; i++) {
						...
						if (this.comboRemoveItem.getSelectedItem().toString().equals(
								(String) this.modelo.getValueAt(i, 2))
								&& this.M == 0) {
							if ((Integer) this.Quantidade2.getValue() > Integer
									.parseInt((String) this.modelo.getValueAt(i,
											3))) {
							...
							if ((Integer) this.Quantidade2.getValue()
									- Integer.parseInt((String) this.modelo
											.getValueAt(i, 3)) == 0
									&& this.M == 0) {
								this.contLinha--;
								...
								this.modelo.setValueAt(
										(String.valueOf(nf
												.format(Integer
														.parseInt((String) this.modelo
																.getValueAt(i,
																		3))
														- (Integer) this.Quantidade2
																.getValue()))),
										i, 3);
								this.modelo.setValueAt(
										(String.valueOf(nf
												.format(Integer
														.parseInt((String) this.modelo
																.getValueAt(i,
																		3))
														* (Double.parseDouble((String) this.modelo
																.getValueAt(i,
																		4)))))),
										i, 5);
							}
					...
					if (this.comboRemoveItem.getSelectedItem().toString().equals(
						...
						if ((Integer) this.Quantidade2.getValue()
							...
							this.modelo.setValueAt((String.valueOf(nf.format(Integer
									.parseInt((String) this.modelo.getValueAt(i,
											3))
									- (Integer) this.Quantidade2.getValue()))),
									i, 3);
							this.modelo.setValueAt((String.valueOf(nf.format(Integer
									.parseInt((String) this.modelo.getValueAt(i,
											3))
									* (Double.parseDouble((String) modelo
											.getValueAt(i, 4)))))), i, 5);
						}
					}
				}
	...
	private void AddItem() {
		...
		if (this.comboProduto.getSelectedItem().toString().equals("")) {
			...
			this.modelo.addRow(new String[] { String.valueOf(this.contLinha), this.codProd,
					...
					(String) this.quantidade.getValue().toString(),
			...
			if (achou == 0) {
				...
				this.valorTotal.setText(String.valueOf(this.vlTotal1));
				this.contLinha++;
				this.modelo.addRow(new String[] { String.valueOf(this.contLinha),
						this.codProd, this.comboProduto.getSelectedItem().toString(),
						(String) this.quantidade.getValue().toString(),
						String.valueOf(this.precoUnitario),
						String.valueOf(nf.format(this.valorT)) });
				this.contitem.setText(String.valueOf(this.contLinha));
	...
	private void CalcularTroco() {
		...
		if (this.par <= 1)
			...
			this.troco = (Double.parseDouble(this.valorPago.getText()) - this.parcela);
	...
	private void CalcularParcelamento() {
		...
		this.valorFinal.setText(String.valueOf(nf.format(this.valorT
				- Double.parseDouble(this.desconto.getText()))));
	}
	...
	protected void ocultarMesa() {
		if (this.contLinha > 0) {
			String comandosql = "UPDATE `erp`.`mesas` SET" + " `numeroVenda` = '"
					+ numeroVenda.getText() + "', `data` = '" + data1.getText()
					+ "', `ultimoPedido` = '" + ultimoPedido.getText().toString()
					+ "', `vendedor` = '" + vendedor.getText() + "', `nomeCliente` = '"
					+ comboNome.getSelectedItem().toString() + "', `cpf` = '"
					+ cpf1.getText() + "', `telefone` = '" + telefone.getText()
					+ "', `formaPagamento` = '"
					+ comboFormaPagamento.getSelectedItem().toString()
					+ "', `quantidade` = '" + comboVezes.getSelectedItem().toString()
					+ "', `valorTotal` = '" + valorTotal.getText() + "', `desconto` = '"
					+ desconto.getText() + "', `valorFinal` = '" + valorFinal.getText()
					+ "', `valorParcelado` = '" + valorParcelado.getText()
					+ "', `valorPago` = '" + valorPago.getText() + "', `valorTroco` = '"
					+ troco1.getText() + "', `status` = '" + "Temporário"
					+ "', `motivo` = '" + "Ativo" + "'WHERE `mesas`.`numeroMesa` = '"
					+ labelMesaX.getText() + "'";
	...
	public void CarregarMesa(String mesa) {
		...
		try {
			...
			while (dados2.next()) {
				this.modelo.addRow(new String[] { dados2.getString("item"),
						dados2.getString("codigoItem"), dados2.getString("descricao"),
