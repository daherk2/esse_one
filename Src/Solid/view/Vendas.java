...
public class Vendas extends JFrame {
	...
	private JMenu			Menu, mnConfigurao, menu_2, menu_3;
	private JMenuBar			menuBar;
	private JMenuItem			menu, sair, menuItem_1, mntmAbrirAjuda;
	public static JTabbedPane	tabbedPaneVendas;
	static JScrollPane		scrollPaneTabela;
	public static DefaultTableModel	modelo, modeloDelivery;
	...
	private static JLabel			labelMaps;
	...
	private JButton				btMapa;
	private JButton				btPesquisar;
	private JButton				btMapsinterno;
	...
	public Vendas() {
		...
		try {
			...
			Menu.setIcon(new ImageIcon(Vendas.class
			...
			sair.setIcon(new ImageIcon(Vendas.class
			...
			mnConfigurao.setIcon(new ImageIcon(
					Vendas.class.getResource("/icones1_24px/1425606625_678124-wrench-screwdriver-128.png")));
			...
			menuDefinirPapelParede.setIcon(new ImageIcon(Vendas.class
			...
			menuItem_3.setIcon(new ImageIcon(Vendas.class
			...
			menu_2.setIcon(new ImageIcon(Vendas.class
			...
			menuItem_1.setIcon(new ImageIcon(Vendas.class
			...
			menu_3.setIcon(new ImageIcon(Vendas.class
			...
			mntmAbrirAjuda.setIcon(new ImageIcon(Vendas.class
			...
			tabbedPaneVendas.setBackground(Color.LIGHT_GRAY);
			...
			internalFrame.setFrameIcon(new ImageIcon(Vendas.class
					.getResource("/logos_solid/SimboloPSemFundo - Copia.png")));
			internalFrame.setBorder(null);
			internalFrame.setFont(new Font("Kalinga", Font.PLAIN, 14));
			internalFrame.setBounds(490, 238, 375, 181);
				...
				public void itemStateChanged(ItemEvent evt) {
					...
					try {
						...
						while (rs1.next()) {
							...
							ImageIcon imagem = new ImageIcon(rs1.getString("imagem")
									.replace("~", "\\"));
			...
			btCancelar_1.setIcon(new ImageIcon(Vendas.class
			...
			btRemoverItem.setIcon(new ImageIcon(Vendas.class
			...
			comboProduto.addItemListener(new ItemListener() {
				public void itemStateChanged(ItemEvent evt) {
					...
					try {
						...
						ResultSet rs1 = x.Consultar(sql);
						while (rs1.next()) {
							precoUnitario = Double.parseDouble(rs1.getString(
									"precoVenda").replace(",", "."));
							...
							labelIcone_4.setIcon(new javax.swing.ImageIcon(img));
							labelIcone_4.setText("");
							str = comboProduto.getSelectedItem().toString()
									+ "           R$ "
									+ rs1.getString("precoVenda") + "           ";
						}
					}
					catch (SQLException ex) {
						ex.printStackTrace();
			...
			comboFormaPagamento.setBounds(913, 80, 184, 32);
			if (Inicio.rd == 0) {
			...
			quantidade1.setModel(new SpinnerNumberModel(new Integer(1), new Integer(1), null,
					new Integer(1)));
			...
			comboVezes.setBounds(1152, 80, 99, 32);
			...
			numeroCheque1.addKeyListener(new java.awt.event.KeyAdapter() {
				public void keyReleased(java.awt.event.KeyEvent evt) {
					numeroCheque1.setText(numeroCheque1.getText()
							.replaceAll("[^0-9]", ""));
			...
			btMesa1.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (btn1 == 0) {
						...
						ResultSet dados = x
								.Consultar("select*from mesas where numeroMesa = '* MESA 1'");
						try {
							dados.next();
			...
			internalFrame_2.setFrameIcon(new ImageIcon(Vendas.class
					.getResource("/logos_solid/SimboloPSemFundo - Copia.png")));
			internalFrame_2.setBounds(522, 192, 300, 250);
			panelGerencMesas.add(internalFrame_2);
			internalFrame_2.setBorder(new TitledBorder(null, "", TitledBorder.LEADING,
					TitledBorder.TOP, null, null));
			internalFrame_2.setBackground(Color.BLACK);
			internalFrame_2.getContentPane().setBackground(Color.WHITE);
			...
			btCancelar.setIcon(new ImageIcon(Vendas.class
					.getResource("/icones1_24px/1425606572_678069-sign-error-128.png")));
			...
			label_6.setIcon(new ImageIcon(Vendas.class
					.getResource("/imagens_principais/abrir_24px.png")));
			...
			label_7.setIcon(new ImageIcon(Vendas.class
					.getResource("/imagens_principais/reservar_24px.png")));
			...
			label_8.setIcon(new ImageIcon(Vendas.class
					.getResource("/imagens_principais/fechar_24px.png")));
			...
			btMesa7.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (btn7 == 0) {
						...
						mesa = ((Component) e.getSource()).getName();
						ResultSet dados = x
								.Consultar("select*from mesas where numeroMesa = '* MESA 7'");
						try {
							dados.next();
							if (dados.getString("numeroVenda").equals("null")) {
								internalFrame_2.setVisible(true);
			...
			btMesa10.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null,
					null));
			...
			btMesa10.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (btn10 == 0) {
						...
						mesa = ((Component) e.getSource()).getName();
						ResultSet dados = x
								.Consultar("select*from mesas where numeroMesa = '* MESA 10'");
						try {
							dados.next();
							if (dados.getString("numeroVenda").equals("null")) {
								internalFrame_2.setVisible(true);
			...
			btMesa20.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (btn20 == 0) {
						...
						mesa = ((Component) e.getSource()).getName();
						ResultSet dados = x
								.Consultar("select*from mesas where numeroMesa = '* MESA 20'");
						try {
							dados.next();
							if (dados.getString("numeroVenda").equals("null")) {
								internalFrame_2.setVisible(true);
			...
			btMesa19.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (btn19 == 0) {
						...
						mesa = ((Component) e.getSource()).getName();
						ResultSet dados = x
								.Consultar("select*from mesas where numeroMesa = '* MESA 19'");
						try {
							dados.next();
							if (dados.getString("numeroVenda").equals("null")) {
								internalFrame_2.setVisible(true);
			...
			btMesa18.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null,
					null));
			...
			btMesa18.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (btn18 == 0) {
						...
						mesa = ((Component) e.getSource()).getName();
						ResultSet dados = x
								.Consultar("select*from mesas where numeroMesa = '* MESA 18'");
						try {
							dados.next();
							if (dados.getString("numeroVenda").equals("null")) {
								internalFrame_2.setVisible(true);
			...
			btMesa17.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null,
					null));
			...
			btMesa17.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (btn17 == 0) {
						...
						mesa = ((Component) e.getSource()).getName();
						ResultSet dados = x
								.Consultar("select*from mesas where numeroMesa = '* MESA 17'");
						try {
							dados.next();
							if (dados.getString("numeroVenda").equals("null")) {
								internalFrame_2.setVisible(true);
			...
			btMesa16.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (btn16 == 0) {
						...
						mesa = ((Component) e.getSource()).getName();
						ResultSet dados = x
								.Consultar("select*from mesas where numeroMesa = '* MESA 16'");
						try {
							dados.next();
							if (dados.getString("numeroVenda").equals("null")) {
								internalFrame_2.setVisible(true);
			...
			btMesa15.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null,
					null));
			...
			btMesa15.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (btn15 == 0) {
						...
						mesa = ((Component) e.getSource()).getName();
						ResultSet dados = x
								.Consultar("select*from mesas where numeroMesa = '* MESA 15'");
						try {
							dados.next();
							if (dados.getString("numeroVenda").equals("null")) {
								internalFrame_2.setVisible(true);
			...
			btMesa14.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null,
					null));
			...
			btMesa14.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (btn14 == 0) {
						...
						mesa = ((Component) e.getSource()).getName();
						ResultSet dados = x
								.Consultar("select*from mesas where numeroMesa = '* MESA 14'");
						try {
							dados.next();
							if (dados.getString("numeroVenda").equals("null")) {
								internalFrame_2.setVisible(true);
			...
			btMesa13.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null,
					null));
			...
			btMesa13.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (btn13 == 0) {
						...
						mesa = ((Component) e.getSource()).getName();
						ResultSet dados = x
								.Consultar("select*from mesas where numeroMesa = '* MESA 13'");
						try {
							dados.next();
							if (dados.getString("numeroVenda").equals("null")) {
								internalFrame_2.setVisible(true);
			...
			btMesa12.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null,
					null));
			...
			btMesa12.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (btn12 == 0) {
						...
						mesa = ((Component) e.getSource()).getName();
						ResultSet dados = x
								.Consultar("select*from mesas where numeroMesa = '* MESA 12'");
						try {
							dados.next();
							if (dados.getString("numeroVenda").equals("null")) {
								internalFrame_2.setVisible(true);
			...
			btMesa11.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null,
					null));
			...
			btMesa11.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (btn11 == 0) {
						...
						mesa = ((Component) e.getSource()).getName();
						ResultSet dados = x
								.Consultar("select*from mesas where numeroMesa = '* MESA 11'");
						try {
							dados.next();
							if (dados.getString("numeroVenda").equals("null")) {
								internalFrame_2.setVisible(true);
			...
			btMesa30.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null,
					null));
			...
			btMesa30.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (btn30 == 0) {
						...
						mesa = ((Component) e.getSource()).getName();
						ResultSet dados = x
								.Consultar("select*from mesas where numeroMesa = '* MESA 30'");
						try {
							dados.next();
							if (dados.getString("numeroVenda").equals("null")) {
								internalFrame_2.setVisible(true);
			...
			btMesa29.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null,
					null));
			...
			btMesa29.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (btn29 == 0) {
						...
						mesa = ((Component) e.getSource()).getName();
						ResultSet dados = x
								.Consultar("select*from mesas where numeroMesa = '* MESA 29'");
						try {
							dados.next();
							if (dados.getString("numeroVenda").equals("null")) {
								internalFrame_2.setVisible(true);
			...
			btMesa28.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null,
					null));
			...
			btMesa28.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (btn28 == 0) {
						...
						mesa = ((Component) e.getSource()).getName();
						ResultSet dados = x
								.Consultar("select*from mesas where numeroMesa = '* MESA 28'");
						try {
							dados.next();
							if (dados.getString("numeroVenda").equals("null")) {
								internalFrame_2.setVisible(true);
			...
			btMesa27.setBorder(new SoftBevelBorder(BevelBorder.LOWERED, null, null, null,
					null));
			...
			label.setIcon(new ImageIcon(Vendas.class.getResource("/papel_parede/01.jpg")));
			label.setHorizontalAlignment(SwingConstants.CENTER);
			label.setBounds(0, 0, 1345, 658);
			...
			internalFrame_1 = new JInternalFrame("GOOGLE MAPS");
			internalFrame_1.setFrameIcon(new ImageIcon(Vendas.class
			...
			labelMaps.setForeground(Color.BLACK);
			labelMaps.setHorizontalAlignment(SwingConstants.CENTER);
			labelMaps.setIcon(new ImageIcon(Vendas.class
					.getResource("/imagens_principais/logo maps.jpg")));
			labelMaps.setBounds(0, 0, 678, 273);
			internalFrame_1.getContentPane().add(labelMaps);
			internalFrame_1.setResizable(true);
			internalFrame_1.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
			internalFrame_1.setBounds(649, 13, 667, 306);
			panelDelivery.add(internalFrame_1);
			...
			telefone4.setBounds(200, 58, 124, 32);
			...
			internalFrame_3.setFrameIcon(new ImageIcon(Vendas.class
					.getResource("/logos_solid/SimboloPSemFundo - Copia.png")));
			internalFrame_3.setBounds(490, 238, 375, 181);
			...
			numeroVendaDelivery.setBounds(91, 58, 97, 32);
			...
			logradouro4.setBounds(91, 180, 403, 32);
			...
			bairro4.setBounds(91, 245, 144, 32);
			...
			numero4.setBounds(245, 245, 64, 32);
			...
			cidade4.setBounds(319, 245, 175, 32);
			...
			complemento4.setBounds(91, 309, 267, 32);
			...
			comboProduto3.setBounds(42, 407, 341, 32);
			panelDelivery.add(comboProduto3);
			sql = "select * from produtos order by nome";
			rs = x.Consultar(sql);
			try {
				
				comboProduto3.removeAll();
			...
			btMapa = new JButton("Navegador");
			btMapa.setForeground(Color.BLACK);
			btMapa.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
			btMapa.setFont(new Font("Kalinga", Font.PLAIN, 14));
			btMapa.setIcon(new ImageIcon(Vendas.class
					.getResource("/icones1_24px/1425606563_map-128.png")));
			btMapa.setToolTipText("Abrir Navegador");
			...
			spinnerQuantDelivery.setBounds(431, 407, 84, 32);
			panelDelivery.add(spinnerQuantDelivery);
			
			JScrollPane scrollPane = new JScrollPane();
			scrollPane.setBounds(42, 440, 473, 101);
			...
			codDelivery.setBounds(370, 309, 124, 32);
			...
			valorFinalDelivery.addKeyListener(new java.awt.event.KeyAdapter() {
				public void keyReleased(java.awt.event.KeyEvent evt) {
					valorFinalDelivery.setText(valorFinalDelivery.getText().replaceAll(
							"[^0-9]", ""));
			...
			valorFinalDelivery.setBounds(52, 573, 141, 32);
			...
			valorPagoDelivery.addKeyListener(new java.awt.event.KeyAdapter() {
				public void keyReleased(java.awt.event.KeyEvent evt) {
					valorPagoDelivery.setText(valorPagoDelivery.getText().replaceAll(
							"[^0-9]", ""));
			...
			valorPagoDelivery.setBounds(208, 573, 141, 32);
			...
			trocoDelivery.addKeyListener(new java.awt.event.KeyAdapter() {
				public void keyReleased(java.awt.event.KeyEvent evt) {
					trocoDelivery.setText(trocoDelivery.getText()
							.replaceAll("[^0-9]", ""));
			...
			trocoDelivery.setBounds(361, 573, 141, 32);
			panelDelivery.add(trocoDelivery);
			btMapa.setBounds(1146, 321, 170, 35);
			panelDelivery.add(btMapa);
			...
			btPesquisar.setBounds(501, 53, 117, 40);
			panelDelivery.add(btPesquisar);
			
			btMapsinterno = new JButton("Maps Interno");
			btMapsinterno.setForeground(Color.BLACK);
			btMapsinterno.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
			btMapsinterno.setIcon(new ImageIcon(Vendas.class
					.getResource("/icones1_24px/1425606704_678074-map-128.png")));
			btMapsinterno.addMouseListener(new MouseAdapter() {
				public void mouseClicked(MouseEvent arg0) {
					Vendas.MapsInterno();
					labelMaps.setVisible(false);
				}
			});
			btMapsinterno.setToolTipText("Navegador Interno");
			btMapsinterno.setFont(new Font("Kalinga", Font.PLAIN, 14));
			btMapsinterno.setBounds(965, 321, 170, 35);
			panelDelivery.add(btMapsinterno);
			...
			btAddItem.setBounds(536, 403, 126, 40);
			...
			btRemItem.setIcon(new ImageIcon(Vendas.class
					.getResource("/icones1_24px/1425606572_678069-sign-error-128.png")));
			btRemItem.setBounds(536, 446, 126, 40);
			...
			btnCalcular.setBounds(536, 565, 126, 40);
			...
			btnSalvar.setBounds(536, 489, 126, 40);
			...
			lblComplemento.setBounds(91, 277, 102, 32);
			...
			lblValorPago.setBounds(208, 540, 141, 32);
			...
			label_15.setBounds(52, 540, 141, 32);
			...
			lblNVenda.setBounds(91, 25, 81, 32);
			...
			lblTroco.setBounds(361, 540, 141, 32);
			...
			label_3.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null,
					...
					new Color(64, 64, 64)));
			label_3.setBounds(22, 12, 609, 344);
			...
			label_4.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null,
					...
					new Color(64, 64, 64)));
			label_4.setBounds(22, 365, 667, 255);
			...
			label_13.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null,
					null), "HIST\u00D3RICO", TitledBorder.LEFT, TitledBorder.TOP, null,
					new Color(64, 64, 64)));
			label_13.setBounds(701, 365, 615, 255);
			...
			valorParcelado1.addKeyListener(new java.awt.event.KeyAdapter() {
				public void keyReleased(java.awt.event.KeyEvent evt) {
					valorParcelado1.setText(valorParcelado1.getText().replaceAll(
							"[^0-9]", ""));
			...
			radioVista.setBounds(997, 46, 80, 32);
			...
			radioPrazo.setBounds(1086, 46, 87, 32);
			...
			menuBar_3.setBounds(565, 0, 221, 32);
			...
			btRecalcularTroco.setBounds(1044, 591, 129, 30);
			...
			labelFundo1.setBackground(Color.WHITE);
			labelFundo1.setHorizontalAlignment(SwingConstants.CENTER);
			labelFundo1.setIcon(new ImageIcon(Vendas.class
					.getResource("/papel_parede/01.jpg")));
			labelFundo1.setBounds(0, 0, 1361, 674);
			...
			cadastro.setBounds(483, 61, 173, 32);
			...
			consulta.setBounds(714, 61, 166, 32);
			...
			btnAtualizar.setIcon(new ImageIcon(Vendas.class
					.getResource("/icones1_24px/1425606570_floppy-128.png")));
			...
			button_8 = new JButton("Selecionar");
			button_8.setForeground(Color.BLACK);
			button_8.setIcon(new ImageIcon(Vendas.class
					.getResource("/icones1_24px/1425606659_678090-camera-128.png")));
			button_8.setFont(new Font("Kalinga", Font.PLAIN, 14));
			button_8.setFocusTraversalPolicyProvider(true);
			button_8.setBounds(702, 236, 146, 35);
			panelCadastrarCliente.add(button_8);
			...
			fotoCliente = new JLabel("(165x115)");
			...
			label_18.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null), "SELECIONAR A\u00C7\u00C3O", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(64, 64, 64)));
			label_18.setBounds(10, 43, 1325, 69);
			...
			Fundo.setBounds(0, 0, 1361, 658);
			Fundo.setIcon(new ImageIcon(Vendas.class.getResource("/papel_parede/01.jpg")));
			...
			lblGrafico.setBounds(875, 78, 450, 500);
			...
			label_12.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"),
								"PRODUTOS MAIS VENDIDOS", TitledBorder.LEADING, TitledBorder.TOP,
								null, new Color(0, 0, 0)));
			label_12.setBounds(20, 78, 832, 500);
			...
			labelFundo1_1.setIcon(new ImageIcon(Vendas.class
					.getResource("/papel_parede/01.jpg")));
			labelFundo1_1.setBounds(0, 0, 1345, 658);
			panelRelatorios.add(labelFundo1_1);
			
			/*
			 * panels com ícones
			 */
			tabbedPaneVendas.addTab("Painel de Vendas ", new ImageIcon(Vendas.class
					.getResource("/icones1_24px/1425606602_678131-money-128.png")),
					panelPainelVendas, null);
			tabbedPaneVendas.addTab("Gerenciador de mesas ", new ImageIcon(Vendas.class
					.getResource("/icones1_24px/1425606605_678077-computer-128.png")),
					panelGerencMesas, null);
			tabbedPaneVendas
					.addTab("Clientes ",
							new ImageIcon(
									Vendas.class.getResource("/icones1_24px/1425606736_678130-profile-alt-4-128.png")),
							panelCadastrarCliente, null);
			tabbedPaneVendas.addTab("Delivery ", new ImageIcon(Vendas.class
					.getResource("/icones1_24px/1425606557_678111-map-marker-128.png")),
					panelDelivery, null);
			tabbedPaneVendas.addTab("Relatórios", new ImageIcon(Vendas.class
	...
	protected static void MapsInterno() {
		...
		internalFrame_1.getContentPane().add(browser.getComponent(), BorderLayout.CENTER);
		browser.navigate("http://maps.google.com.br");
		
	}
	
	protected static void abrirmapa() {
		try {
			java.awt.Desktop.getDesktop().browse(
					new java.net.URI("https://www.google.com.br/maps"));
		}
	...
	public static void LimparCliente() {
		...
		codigoCliente3.setText(null);
		nome3.setText(null);
		nascimento3.setText(null);
		nacionalidade3.setText(null);
		rg3.setText(null);
		cpf3.setText(null);
		comboEstadoCivil.setSelectedItem(null);
		email3.setText(null);
		nomePai3.setText(null);
		nomeMae3.setText(null);
		autorizados3.setText(null);
		telefone3.setText(null);
		celular3.setText(null);
		telefone23.setText(null);
		celular23.setText(null);
		logradouro3.setText(null);
		numero3.setText(null);
		complemento3.setText(null);
		bairro3.setText(null);
		comboUf3.setSelectedItem(null);
		comboCidade3.setSelectedItem(null);
		cep3.setText(null);
		autorizados3.setText(null);
	...
	private static void TabelaHistorico() {
		...
		scrollPane_1.setBounds(47, 99, 779, 459);
		...
		Tabela_hist.setModel(new DefaultTableModel(
			...
			new String[] {
				"LOCAL", "N DA VENDA", "DATA ", "HORA", "VENDEDOR", "CLIENTE", "FORM. PAG.", "VALOR"
			}
		) {
