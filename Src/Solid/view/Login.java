...
public class Login extends JFrame {
	...
	public Login() {
		...
		btnVisualizarSenha.setForeground(Color.LIGHT_GRAY);
		...
		labelIconeSolid.setIcon(new ImageIcon(Login.class
				.getResource("/logos_solid/LogoSemFundo - Copia.png")));
		...
		labelFundoLogin.setIcon(new ImageIcon(Login.class
				.getResource("/papel_parede/grade4.jpg")));
		labelFundoLogin.setBounds(0, 0, 765, 443);
