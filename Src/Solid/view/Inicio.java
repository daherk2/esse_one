...
public class Inicio extends JFrame {
	...
	public static int			mesasAbertas	= 0;
	...
	private Animation createAnimation() {
		...
		Animation a3 = BasicTextAnimation.defaultScale(textMensagem, 500, "SOLUÇÃO",
				Color.WHITE);
		Animation a4 = BasicTextAnimation.defaultScale(textMensagem, 500, "EM", 
				Color.WHITE);
		Animation a5 = BasicTextAnimation.defaultSpace(textMensagem, 500, "GESTÃO", 
				Color.WHITE);
		Animation a6 = BasicTextAnimation.defaultSpace(textMensagem, 500, "EMPRESARIAL !!",
				Color.WHITE);
		Animation a7 = BasicTextAnimation.defaultSpace(textMensagem, 500, "",
				Color.WHITE);
	...
	public Inicio() {
		...
		progressBar.setBounds(0, 469, 784, 25);
